...
export PATH=/home/iqbal/.local/bin:$PATH
...
# User configuration
# oh-my-posh prompts
# eval "$(oh-my-posh init zsh --config /home/iqbal/Downloads/Git/2KAbhishek/Posh2K/posh2k.omp.json)"
...
source ~/Downloads/Git/fzf-git.sh/fzf-git.sh
